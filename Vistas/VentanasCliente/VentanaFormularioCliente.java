...
public abstract class VentanaFormularioCliente extends JFrame {
    ...
    /**
     * Método que las subclases deben implementar para agregar componentes adicionales
    ...
    public void mostrarCliente(Cliente cliente) {
        ...
        campoInisus.setText(cliente.getIniSus().toString()); // Asegúrate de que el formato sea correcto
    }
